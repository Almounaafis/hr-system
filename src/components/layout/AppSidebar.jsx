    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="flex h-7 w-7 md:h-12 md:w-12 shrink-0 items-center justify-center rounded-xl bg-background shadow-sm">
              <img src={basma} alt="Basma" className=" h-5 md:h-8  w-5 md:w-8" />
            </div>
            <h1 className="md:text-2xl font-bold text-primary">بصمة</h1>
          </Link>
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    title={item.name}
                    className={cn(
                      "flex h-12 items-center rounded-xl px-3 justify-between transition-all duration-300",
                      isActive
          ...
          >
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-muted text-sm font-medium">
              {user?.profile_image_url ? (
                <img src={user.profile_image_url} alt="user" className="h-9 w-9 rounded-full object-cover" />
              ) : (
